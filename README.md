...
`public/geojson/china` 里的 GeoJSON 已替换为公开 DataV.GeoAtlas 行政区划边界文件。方言归属来源已改为《中国语言地图集》第2版与中国语言资源保护工程采录展示平台，并补充了省级基础覆盖。示例数据仍未声称完整；没有公开可核验的城市级方言使用人口比例时，不填写 `percentage`，页面显示“暂无精确数据”。
